...
<section class="py-5 bg-dark text-white border-top border-secondary">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            <?php
            $team = [
                ['name' => 'Issa Abdullah', 'icon' => 'bi-database'],
                ['name' => 'Brian Bwogo', 'icon' => 'bi-code-slash'],
                ['name' => 'Nimrod Kobia', 'icon' => 'bi-brush'],
                ['name' => 'Ryan Mbugua', 'icon' => 'bi-server'],
                ['name' => 'Chief Mwijukye', 'icon' => 'bi-palette'],
                ['name' => 'Mohamedek Yussuf', 'icon' => 'bi-laptop']
            ];
            ...
            foreach ($team as $member): ?>
                <div class="col-lg-4 col-md-6">
                    <div class="team-card bg-black p-4 rounded-4 border border-secondary text-center h-100">
                        ...
                        <h4 class="fw-semibold text-white mb-0"><?= htmlspecialchars($member['name']) ?></h4>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
